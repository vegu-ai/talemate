    ...
    data() {
        return {
            ...
            helpMessages: {
                ...
                agent_persona: "Agent personas define how an agent should present and behave in prompts (tone, perspective, style). Assign a persona per agent in Scene Settings.",
