"""
Baseline snapshot tests for world_state agent prompt templates (reasoning enabled).
...
class TestWorldStateAnalyzeBaselines:
    """Baseline tests for world_state analyze methods (reasoning enabled)."""
...
class TestWorldStateIdentifyBaselines:
    """Baseline tests for world_state identify methods (reasoning enabled)."""
...
class TestWorldStateExtractBaselines:
    """Baseline tests for world_state extract methods (reasoning enabled)."""
...
class TestWorldStateRequestBaselines:
    """Baseline tests for world_state request methods (reasoning enabled)."""
...
class TestWorldStateReinforcementBaselines:
    """Baseline tests for world_state reinforcement methods (reasoning enabled)."""
...
class TestWorldStatePinBaselines:
    """Baseline tests for world_state pin condition methods (reasoning enabled)."""
...
class TestWorldStatePresenceBaselines:
    """Baseline tests for world_state character presence methods (reasoning enabled)."""
...
class TestWorldStateQueryBaselines:
    """Baseline tests for world_state query methods (reasoning enabled)."""
...
class TestWorldStateCharacterProgressionBaselines:
    """Baseline tests for world_state character progression methods (reasoning enabled)."""
