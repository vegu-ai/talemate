<template>
    <v-card elevation="3" class="mb-2" density="compact" variant="outlined" color="time">
        ...
        <v-card-text>
            ...
            <div v-else class="d-flex align-center">
                ...
                <v-btn class="ml-2" color="primary" size="small"
                    @click="save" :disabled="locked">Save</v-btn>
