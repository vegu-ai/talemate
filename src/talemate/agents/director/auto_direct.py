        ...
        actions["auto_direct"] = AgentAction(
            ...
            config={
                ...
                "instruct_actors": AgentActionConfig(
                    ...
                    description="Give direction to actors.",
                    value=False,
                    condition=NATURAL_FLOW_CONDITION,
                ),
                "instruct_narrator": AgentActionConfig(
                    type="bool",
                    label="Include narrator",
                    description="Include the narrator in the natural flow direction.",
                    value=False,
                    condition=NATURAL_FLOW_CONDITION,
                ),
                "evaluate_scene_intention": AgentActionConfig(
                    ...
                    description="Evaluate the scene intention and adjust the direction accordingly. This can be 0 for never, or the frequency at which to evaluate the scene intention. Time skips will also trigger an evaluation.",
                    value=0,
                    min=0,
                    max=25,
                    step=1,
