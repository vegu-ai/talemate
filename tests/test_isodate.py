...
def test_isodate_utils():
    ...
    assert iso8601_duration_to_human(date1, flatten=False) == "11 Months and 15 Minutes ago", iso8601_duration_to_human(date1, flatten=False)
    assert iso8601_duration_to_human(date2, flatten=False) == "1 Second ago",  iso8601_duration_to_human(date2, flatten=False)
    assert iso8601_duration_to_human(iso8601_diff(date1, date2), flatten=False) == "11 Months, 14 Minutes and 59 Seconds ago", iso8601_duration_to_human(iso8601_diff(date1, date2), flatten=False)
...
@pytest.mark.parametrize("a, b, expected", [
    ...
    ("P1Y2M3DT4H5M6S", "PT0S", "1 Year, 2 Months, 3 Days, 4 Hours, 5 Minutes and 6 Seconds ago"),
